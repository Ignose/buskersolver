  ...
  try {
    var _loop = function _loop() {
      var _step$value = _step.value,
        effects = _step$value.effects,
        daRaw = _step$value.daRaw,
        buskIndex = _step$value.buskIndex;
      ...
      var _iterator2 = src_utils_createForOfIteratorHelper(modifiers),
        _step2;
      try {
      ...
      var _iterator3 = src_utils_createForOfIteratorHelper(modifiers),
        _step3;
      try {
      ...
      if (othermodifiers) {
        ...
        if (otherMods.length > 0) {
          ...
          var _iterator4 = src_utils_createForOfIteratorHelper(otherMods),
            _step4;
          try {
            var _loop2 = function _loop2() {
      ...
      var bestOutfit = findOutfit(daRaw, true);
      if (bestOutfit === null) {
        (0,external_kolmafia_namespaceObject.print)("No viable outfit found, something went horribly wrong!");
      } else {
        var hat = bestOutfit.hat !== null ? bestOutfit.hat : external_kolmafia_namespaceObject.Item.none;
        var shirt = bestOutfit.shirt !== null ? bestOutfit.shirt : external_kolmafia_namespaceObject.Item.none;
        var pants = bestOutfit.pants !== null ? bestOutfit.pants : external_kolmafia_namespaceObject.Item.none;
        (0,external_kolmafia_namespaceObject.print)("Outfit: Hat -  ".concat(hat, ",  Shirt -  ").concat(shirt, ",  Pants -  ").concat(pants));
      }
...
function hybridEffectValuer(desiredEffects, weightedModifiers) {
  ...
  return (effect, duration) => {
    ...
    return sum(Object.entries(weightedModifiers), _ref11 => {
...
function normalizeEffectValuer(valuer) {
  if (typeof valuer === "function") {
    ...
    // eslint-disable-next-line @typescript-eslint/no-unused-vars
    return (effect, _duration) => sum(Object.entries(valuer), _ref13 => {
...
function scoreBusk(effects, effectValuer, uselessEffects) {
  var useful = effects.filter(_ref15 => {
    var _ref16 = utils_slicedToArray(_ref15, 1),
      e = _ref16[0];
    return !uselessEffects.has(e);
  });
  return sum(useful, _ref17 => {
    var _ref18 = utils_slicedToArray(_ref17, 2),
      e = _ref18[0],
      dur = _ref18[1];
...
function findOptimalOutfitPower(effectValuer) {
  ...
  return maxBy(powersums, power => scoreBusk(Object.entries((0,external_kolmafia_namespaceObject.beretBuskingEffects)(power + pathHatPower(), buskUses)).map(_ref19 => {
    ...
    var _ref22 = utils_slicedToArray(_ref21, 1),
      e = _ref22[0];
    return e !== template_string_$effect.none;
...
var populateMap = (arr, max, double) => {
  var map = new Map();
  var _iterator5 = src_utils_createForOfIteratorHelper(arr),
    _step5;
  try {
    for (_iterator5.s(); !(_step5 = _iterator5.n()).done;) {
      var it = _step5.value;
      var power = (0,external_kolmafia_namespaceObject.getPower)(it) * double;
      if (power > max) continue;
      var existing = map.get(power);
      if (!existing || !have(existing) && (have(it) || (0,external_kolmafia_namespaceObject.npcPrice)(it) < (0,external_kolmafia_namespaceObject.npcPrice)(existing))) {
        map.set(power, it);
      }
    }
  } catch (err) {
...
var functionalPrice = item => have(item) || item === external_kolmafia_namespaceObject.Item.none ? 0 : (0,external_kolmafia_namespaceObject.npcPrice)(item);
...
function findOutfit(power, buyItem) {
  ...
  var outfits = utils_toConsumableArray(hatPowers).flatMap(_ref23 => {
    var _ref24 = utils_slicedToArray(_ref23, 2),
      hatPower = _ref24[0],
      hat = _ref24[1];
    return utils_toConsumableArray(pantsPowers).flatMap(_ref25 => {
      var _ref26 = utils_slicedToArray(_ref25, 2),
        pantsPower = _ref26[0],
        pants = _ref26[1];
      return utils_toConsumableArray(shirtPowers).flatMap(_ref27 => {
  ...
  var _iterator6 = src_utils_createForOfIteratorHelper(relevantSlots),
    _step6;
  try {
    for (_iterator6.s(); !(_step6 = _iterator6.n()).done;) {
      var slot = _step6.value;
...
function main(command) {
  ...
  if (args.uniqueeffects) {
    uselesseffects.push.apply(uselesseffects, main_toConsumableArray(external_kolmafia_namespaceObject.Effect.all().filter(e => have(e))));
  }
  var startUses = args.allbusks ? 0 : property_get("_beretBuskingUses", 0);
  var buskRange = args.busk !== undefined ? [args.busk - 1] : Array.from({
    length: 5 - startUses
  }, (_, i) => startUses + i);
  if (args.effects !== external_kolmafia_namespaceObject.Effect.none.name || args.modifiers !== external_kolmafia_namespaceObject.Modifier.none.name) {
    var desiredEffects = args.effects !== external_kolmafia_namespaceObject.Effect.none.name ? parseEffects(args.effects) : [];
    var weightedModifiers = args.modifiers !== external_kolmafia_namespaceObject.Modifier.none.name ? parseWeightedModifiers(args.modifiers) : {};
